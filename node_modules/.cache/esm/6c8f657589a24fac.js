let Menu;_89a‍.x([["riceList",()=>riceList],["mainList",()=>mainList],["sideList",()=>sideList],["soupList",()=>soupList]]);_89a‍.w("../../models/menu",[["default",["Menu"],function(v){Menu=v}]]);

       const riceList = async ctx => {
    const request = parseInt(ctx.request.body.number);
    _89a‍.g.console.log(ctx.request.body)
    const ricesAraay = [];
    ctx.body = [];
